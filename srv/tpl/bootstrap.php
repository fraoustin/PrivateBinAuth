...
?>
					...
					<a href="./login"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span> logout</a>
					</li>
				</ul>
			</div>
		<?php
...
?>
				...
				<ul id="editorTabs" class="nav nav-tabs hidden">
					...
					<li role="presentation">
						<a role="tab" aria-selected="false" aria-controls="editorTabs" id="messagepreview" href="#" data-toggle="dropdown"><?php echo I18n::_('Preview'); ?></a>
					</li>
					<li role="presentation">					
						<a id="formatter" href="#" class="hidden dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span id="pasteFormatterDisplay"><?php echo $FORMATTER[$FORMATTERDEFAULT]; ?></span></a>
						<ul class="dropdown-menu">
						<?php
							foreach ($FORMATTER as $key => $value) :
						?>
